...
| [005](005-component-strategy.md) | 组件：Tailwind v4 + geistcn 可用则用，业务件自建 | active | components |
| [006](006-charts-library.md) | 图表：SVG sparkline 自绘 + uPlot 时序主图 | active | charts |
| [007](007-project-structure.md) | 目录：路由域分组 + api/ 契约生成层 | active | structure |
